...
public class market {
    ...
    public static void main(String[] args) {
        ...
        daftarProduk.add(new Produk("gula", 5000));
        daftarProduk.add(new Produk("Mie Goreng", 3000));
        daftarProduk.add(new Produk("beras", 120000));
        daftarProduk.add(new Produk("teh", 8000));
        daftarProduk.add(new Produk("susu", 10000));
        daftarProduk.add(new Produk("kopi", 3000));
